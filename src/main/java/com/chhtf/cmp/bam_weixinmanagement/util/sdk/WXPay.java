package com.chhtf.cmp.bam_weixinmanagement.util.sdk;


import java.util.HashMap;
import java.util.Map;

import com.chhtf.cmp.bam_weixinmanagement.util.sdk.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        if (useSandbox) {
            ...
            this.signType = SignType.MD5;//HMACSHA256
        }
